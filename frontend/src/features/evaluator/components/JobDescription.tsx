...
export const JobDescription = ({ value, onChange }: JobDescriptionProps) => {
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 bg-black border border-neutral-800 rounded-xl p-3 flex flex-col">
        <textarea 
          value={value}
          onChange={(e) => onChange(e.target.value)}
          maxLength={7000}
          placeholder="Paste the full job description here...&#10;e.g. 'Senior Frontend Engineer at Google requires proficiency in React...'"
          className="flex-1 w-full bg-transparent text-sm text-zinc-300 placeholder:text-zinc-600 focus:outline-none resize-none leading-relaxed min-h-[350px] p-2"
        />
